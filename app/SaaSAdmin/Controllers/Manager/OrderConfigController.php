...
class OrderConfigController extends Controller
{
    ...
    public function getAppleCallbackVerifyStatus(Request $request)
    {
        ...
        $call_back_verify_status = Cache::connection('api_cache')->get($cache_key);
    ...
    public function verifyNotify(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                Cache::connection('api_cache')->put($cache_key, $call_back_verify_status, self::APPLE_CALLBACK_VERIFY_CACHE_TTL);
                sleep(2);
