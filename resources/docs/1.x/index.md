...
- ## 接口列表
    ...
    - [获取产品列表（非Apple平台）](/{{route}}/{{version}}/apis/product_list)
    - [获取产品详情（非Apple平台）](/{{route}}/{{version}}/apis/product_info)
    - [获取Apple平台产品列表](/{{route}}/{{version}}/apis/apple_product_list)
    - [获取Apple平台产品详情](/{{route}}/{{version}}/apis/apple_product_info)
