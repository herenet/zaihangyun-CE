    ...
    $(function () {
        ...
        function appendParameters(params) {
            ...
            for (var param in params) {
                ...
                if(params[param].readonly == true) {
                    append.find('.param-val').attr('readonly', 'readonly');
                }
                ...
                if (params[param].required == true) {
                    append.find('.param-required').removeClass('hide');
                    append.find('.remove-icon').addClass('hide');
                }
    ...
    <div class="col-md-3">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="false">接口列表</a></li>
                {{--<li><a href="#tab_2" data-toggle="tab" aria-expanded="true">历史</a></li>--}}
            </ul>
        ...
        <div class="box box-info">
            ...
            <form class="form-horizontal api-tester-form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" name="uri" readonly="readonly" class="form-control uri">
                    ...
                    <div class="form-group header-token hide">
                        <label for="Header" class="col-sm-2 control-label">Header</label>

                        <div class="col-sm-10">
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <a class="btn bg-gray btn-flat alert-info">Bearer</a>
                                </span>
                                <input type="text" class="form-control header-token-input" name="token" placeholder="Enter a token">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 0px;">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <i class="fa fa-warning" style="color: orange;margin-left: 10px;margin-right: 5px;"></i><text class="text-danger">请注意接口调用对线上数据的影响</text>
                        </div>
                    </div>
...
<template class="param-tpl">
    ...
    <div class="form-inline param">
        ...
        <div class="form-group"> <!-- Username field -->
            <input type="text" name="key[__index__]" class="form-control param-key" readonly="readonly" style="width: 120px" placeholder="Key"/>
        </div>
        <div class="form-group">
            <div class="input-group">
        ...
        <div class="form-group text-red remove-icon">
