        ...
        <div class="footer-grid">
            ...
            <div class="footer-column">
                ...
                <div class="footer-social">
                    ...
                    <a href="/about#contact-info-section" title="联系我们">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="footer-nav-group">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/">功能特性</a></li>
                        <li><a href="/pricing#faq-section">常见问题</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/about#contact-info-section">联系我们</a></li>
                        <li><a href="/about#timeline-section">发展历程</a></li>
                    </ul>
                </div>
            </div>
        </div>
