...
class IAPSingleCheck extends Field
{
    ...
    public function render()
    {
        ...
        // 添加模态框 HTML
        Admin::html(<<<HTML
            <div class="modal interface-check-modal {$this->column}" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary confirm-btn {$this->column}">确定</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        Admin::script(<<<JS
            $(function () {
                $('.interface-check-btn.{$this->column}').on('click', function() {
                    var btn = $(this);
                    var modal = $('.interface-check-modal.{$this->column}');
                    var confirmBtn = modal.find('.confirm-btn.{$this->column}');
