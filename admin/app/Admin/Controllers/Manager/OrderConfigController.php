...
use App\Admin\Forms\IAPConfig;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use App\Http\Controllers\Controller;
use App\Models\OrderInterfaceConfig;
use Illuminate\Support\Facades\Http;
use App\Admin\Forms\AlipayConfig;
use Illuminate\Support\Facades\Cache;
use App\Admin\Forms\OrderBaseConfig;
use App\Admin\Forms\WechatPayConfig;
use App\Admin\Forms\AppleVerifyConfig;
...
class OrderConfigController extends Controller
{
    ...
    public function saveBase(Request $request)
    {
        ...
        if ($switch == 1) {
            ...
            try {
                app(OrderInterfaceConfig::class)->saveConfig($app_key, $order_config_data);
            ...
            app(OrderInterfaceConfig::class)->saveConfig($app_key, ['switch' => $switch]);
            $this->clearAPICache($app_key);
            admin_toastr('保存成功', 'success');
            return back();
        }
    ...
    public function saveAlipay(Request $request)
    {
        ...
        try {
            ...
            if ($request->input('suport_alipay') == 1) {
                ...
                app(AlipayConfigModel::class)->saveConfig($app_key, $alipay_config_data);
            }
    ...
    public function saveIAP(Request $request)
    {
        ...
        try {
            ...
            if ($request->input('suport_apple_pay') == 1) {
                ...
                app(IAPConfigModel::class)->saveConfig($app_key, $apple_iap_config_data);
            }
            app(OrderInterfaceConfig::class)->saveConfig($app_key, $order_config_data);
            $this->clearAPICache($app_key);
            DB::commit();
    ...
    public function saveAppleVerify(Request $request)
    {
        ...
        try {
            ...
            if ($request->input('suport_apple_verify') == 1) {
                ...
                app(AppleVerifyConfigModel::class)->saveConfig($app_key, $apple_verify_config_data);
            }
